...
const Footer = () => {
  return (
    <section className="container px-4 sm:py-20 py-12 mx-auto bg-background sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            ...
            <ul className="flex items-center space-x-3 mt-9">
              <li>
                <a
                  href="#"
                  title=""
                  className="flex items-center justify-center text-muted-foreground transition-all duration-200 bg-muted rounded-full w-7 h-7 hover:bg-primary hover:text-primary-foreground"
                >
                  <svg
                    className="w-4 h-4"
          ...
          <div className="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
            ...
            <form action="#" method="POST" className="mt-6">
              <div className="mb-4">
                <Field>
                  <Input placeholder="john@example.com" required />
                </Field>
              </div>
